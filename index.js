...
</li>`).join("");c.innerHTML=r,w.refresh()}function y(){c.innerHTML=""}function L(){u.classList.add("load")}function n(){u.classList.remove("load")}let w=new d(".gallery a",{captions:!0,captionsData:"alt",captionDelay:250});const b=document.querySelector("form"),S=document.querySelector('input[type="text"]');b.addEventListener("submit",q);function q(i){i.preventDefault(),y();const r=S.value.trim();r&&(L(),g(r).then(t=>{if(t.length)n(),h(t);else{n(),l();return}}).catch(t=>{n(),l()}))}function l(){m.show({position:"topRight",theme:"dark",backgroundColor:"#EF4040",message:"Sorry, there are no images matching your search query. Please, try again!",messageColor:"#fff",iconUrl:"./img/error.svg",messageSize:"16px"})}
